...
namespace Blog.Migrations
{
    ...
    public partial class RefectorModelDomain : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "INSCRICOES_BLOG",
                columns: table => new
                {
                    InscricaoBlogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BlogId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_INSCRICOES_BLOG", x => x.InscricaoBlogId);
                    table.ForeignKey(
                        name: "FK_INSCRICOES_BLOG_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_INSCRICOES_BLOG_BLOGS_BlogId",
                        column: x => x.BlogId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Conteudo = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_POSTAGENS_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_POSTAGENS_BLOGS_BlogId",
                        column: x => x.BlogId,
                        principalTable: "BLOGS",
                        principalColumn: "BlogId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_INSCRICOES_BLOG_BlogId",
                table: "INSCRICOES_BLOG",
                column: "BlogId");

            migrationBuilder.CreateIndex(
                name: "IX_INSCRICOES_BLOG_UserId",
                table: "INSCRICOES_BLOG",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_POSTAGENS_BlogId",
                table: "POSTAGENS",
                column: "BlogId");

            migrationBuilder.CreateIndex(
                name: "IX_POSTAGENS_UserId",
                table: "POSTAGENS",
                column: "UserId");
        }
